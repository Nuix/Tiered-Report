...
/***
 * Item aspect which categorizes items based on the CC addresses associated with those items.
 * @author Jason Wells
 *
 */
public class CcAddressesAspect extends AbstractItemAspect {
	...
	public void recordItemValues(Case nuixCase, Utilities utilities, Map<Object, RoaringBitmap> aspectBitmaps, TieredReportData data, Item item, ItemInfo itemInfo) {
		...
		if(comm != null){
			...
			distinctAddresses.addAll(comm.getCc());
